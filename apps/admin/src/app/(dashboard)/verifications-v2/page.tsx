// v2 route — feature flag: ADMIN_V2_VERIFICATION_QUEUE
// This page is an independent implementation of the verifications queue.
// It does NOT re-export from ../verifications/page — it owns its own data fetch.
// v2 enhancement: capability-aware role indicator in queue header.
// Enable NEXT_PUBLIC_ADMIN_FF_V2_VERIFICATION_QUEUE to serve this route.
...
interface VerificationsV2PageProps {
...
export default async function VerificationsV2Page({
  searchParams,
}: VerificationsV2PageProps) {
  ...
  // Fetch stats, queue data, and permissions in parallel
  ...
  return (
    <div className="space-y-6" data-v2-route="verifications">
      {/* Page Header — v2 enhancement: capability-aware role indicator */}
