// v2 route — feature flag: ADMIN_V2_FINANCE_DASHBOARD
// This page is an independent implementation of the analytics dashboard.
// It does NOT re-export from ../analytics/page — it owns its own data fetch.
// Enable NEXT_PUBLIC_ADMIN_FF_V2_FINANCE_DASHBOARD to serve this route.
...
export default function AnalyticsV2Page() {
  return (
    <div className="space-y-6" data-v2-route="analytics">
      {/* Header */}
      <div>
