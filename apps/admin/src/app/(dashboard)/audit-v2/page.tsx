// v2 route — feature flag: ADMIN_V2_AUDIT_LOG_UI
// This page is an independent implementation of the audit log.
// It does NOT re-export from ../audit/page — it owns its own data fetch.
// Enable NEXT_PUBLIC_ADMIN_FF_V2_AUDIT_LOG_UI to serve this route.
...
async function AuditStats() {
  ...
  void weekCount; // available for future week-total stat card
...
async function AuditLogsList({
  ...
  searchParams: AuditV2PageProps["searchParams"];
}) {
              ...
              <div key={log.id}>
                <div className="flex items-start gap-4 py-4 hover:bg-zinc-50 rounded-lg px-3 -mx-3 transition-colors">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    {/* Show detail changes if available */}
...
export default async function AuditV2Page({ searchParams }: AuditV2PageProps) {
  return (
    <div className="space-y-6" data-v2-route="audit">
      {/* Page Header */}
      <div>
