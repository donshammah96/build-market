...
const ProfessionalItem: FC<ProfessionalItemProps> = ({
  title,
  description,
}) => {
  return (
    <div className="flex flex-col gap-2">
      <h3 className="text-black text-xl sm:text-2xl font-medium font-inter leading-7 sm:leading-9">
        {title}
      </h3>
      <p className="text-zinc-500  text-xl sm:text-2xl font-normal font-inter leading-7 sm:leading-9">
        {description}
      </p>
    </div>
  );
...
export const ProfessionalsSection: React.FC<{ searchTerm: string }> = ({
  searchTerm,
}) => {
  ...
  return (
    <section className="flex flex-col w-[516px] items-end gap-12 relative">
      <h2 className="text-black  text-3xl sm:text-4xl font-semibold font-inter">
        Browse Professionals Near You
      </h2>
      ...
      <div className="mt-6 text-center">
        <button className="px-4 sm:px-6 py-2 sm:py-3 bg-neutral-200  rounded-lg shadow text-black  text-xl sm:text-2xl font-medium font-inter leading-7 sm:leading-9">
          <Link
            ...
            className="text-black  hover:underline text-xl font-medium inline-flex items-center gap-1"
          >
            Explore more!
          </Link>
        </button>
