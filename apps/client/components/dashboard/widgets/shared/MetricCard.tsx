          ...
          <div className="motion-safe:animate-pulse space-y-4">
            <div className="flex justify-between">
              ...
              <div className="flex gap-1">
                {[1, 2, 3, 4, 5, 6, 7].map((i) => (
                  <div key={i} className="w-1.5 h-8 bg-muted rounded" />
                ))}
              </div>
            </div>
  ...
  return (
    <Card
      className={cn(
        ...
        highlight
          ? "bg-gradient-to-br from-foreground via-foreground to-primary border-0 shadow-[0_20px_50px_-12px_rgba(0,0,0,0.35)] hover:shadow-[0_25px_60px_-12px_rgba(0,0,0,0.45)] motion-safe:hover:-translate-y-1"
          : "border border-border/80 shadow-sm hover:shadow-lg motion-safe:hover:-translate-y-0.5 bg-card/90 backdrop-blur-sm",
        className,
      )}
    >
        ...
        <div className="flex justify-between items-start mb-6">
          <div
            className={cn(
              ...
              highlight
                ? "bg-gradient-to-br from-primary/30 to-primary/10 text-primary-foreground ring-1 ring-primary/30"
                : "bg-gradient-to-br from-muted to-muted/60 border border-border/60 text-muted-foreground group-hover:text-foreground group-hover:border-border",
            )}
          >
                ...
                <div
                  ...
                  className={cn(
                    ...
                    highlight
                      ...
                      : "bg-gradient-to-t from-muted-foreground to-muted",
                  )}
                  style={{
                    height: `${h}%`,
