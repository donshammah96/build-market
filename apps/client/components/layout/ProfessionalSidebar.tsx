...
const navItems = [
  { label: "Overview", href: "/professional-portal/dashboard", icon: LayoutDashboard },
  ...
  { label: "Messages", href: "/professional-portal/messages", icon: MessageSquare },
  { label: "Portfolio", href: "/professional-portal/portfolio", icon: ImageIcon },
  ...
  return (
    <aside className="fixed inset-y-0 left-0 z-50 w-64 bg-zinc-900 text-white hidden lg:flex flex-col border-r border-zinc-800">
      ...
      <nav className="flex-1 px-4 space-y-1">
        <p className="px-2 text-xs font-semibold text-zinc-500 uppercase tracking-wider mb-2">Management</p>
        {navItems.map((item) => {
        ...
        <div className="pt-8">
           <p className="px-2 text-xs font-semibold text-zinc-500 uppercase tracking-wider mb-2">Account</p>
           <Link href="/professional-portal/settings">
              <div className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium text-zinc-400 hover:bg-zinc-800 hover:text-white transition-all">
