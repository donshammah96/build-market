    ...
    <>
      ...
      >
        <div className="max-w-7xl mx-auto px-4 md:px-8 h-full flex items-center justify-between">
          ...
          {/* Logo Section */}
          <Link href={ROUTES.userDashboard} className="flex items-center gap-2 group">
            ...
            {navItems.map((item) => {
              ...
              return (
                <Link key={item.href} href={item.href}>
                  ...
                  >
                    <Icon className={cn("h-4 w-4", isActive ? "text-emerald-600" : "text-zinc-400")} />
                    {item.label}
                  </Button>
                </Link>
              );
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            {/* Notifications */}
            <Button variant="ghost" size="icon" className="text-zinc-500 hover:text-emerald-600 hover:bg-emerald-50 relative hidden sm:flex rounded-full">
            ...
            <div className="flex items-center gap-3">
              <div className="hidden lg:block text-right">
                <p className="text-sm font-semibold text-zinc-900 leading-none">My Account</p>
                <Link href="/profile" className="text-xs text-zinc-500 hover:text-emerald-600 transition-colors">
                  Manage Profile
                </Link>
              </div>
              <UserButton 
