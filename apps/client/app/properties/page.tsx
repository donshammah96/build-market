          ...
          <div className="relative z-10 w-full max-w-4xl mx-auto space-y-8">
            ...
            >
              ...
              <p className="text-lg md:text-xl text-zinc-200 max-w-2xl mx-auto font-light">
                Discover homes for sale, apartments for rent, and prime land across Kenya.
              </p>
            </motion.div>
            ...
            >
              <Tabs defaultValue="buy" onValueChange={setActiveTab} className="w-full">
                ...
                <div className="flex flex-col md:flex-row gap-2 p-2">
                  ...
                  <Button size="lg" className="h-12 px-8 bg-emerald-600 hover:bg-emerald-700 text-white font-semibold">
                    Search
                  </Button>
                </div>
              </Tabs>
        ...
        <section className="py-20 container mx-auto px-4 md:px-8 max-w-7xl">
          <div className="flex justify-between items-end mb-10">
            <div>
              ...
              <p className="text-zinc-500 mt-2">Curated properties selected for you.</p>
            </div>
            <Button variant="outline" className="hidden sm:flex border-zinc-200 text-zinc-600 hover:text-emerald-600 group">
          ...
          <div className="container mx-auto px-4 relative z-10 flex flex-col md:flex-row items-center justify-between gap-12 max-w-6xl">
            <div className="max-w-xl">
              ...
              <p className="text-zinc-300 text-lg mb-8 leading-relaxed">
                List your properties on Build Market and connect with serious buyers and tenants. Get verified to boost your visibility.
              </p>
              <div className="flex gap-4">
                ...
                <Button size="lg" variant="outline" className="border-zinc-700 text-white hover:bg-white/10 hover:text-white hover:border-white">
                  Learn More
                </Button>
              </div>
            </div>
            ...
            <div className="relative w-full md:w-[400px] aspect-square bg-zinc-800 rounded-2xl border border-zinc-700 p-6 rotate-3 hover:rotate-0 transition-transform duration-500">
               ...
               <div className="h-full flex flex-col justify-center items-center text-center">
                  ...
                  <p className="text-zinc-400 mt-2">The trusted platform for Kenyan Real Estate.</p>
               </div>
            </div>
          </div>
        </section>
