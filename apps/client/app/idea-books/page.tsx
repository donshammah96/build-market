        ...
        {isLoading ? (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 pb-20">
            ...
            >
              ...
              <span className="font-semibold text-zinc-500 group-hover:text-emerald-700">
                Create New Board
              </span>
            </motion.button>
          </div>
...
function IdeaBookCard({
  book,
  index,
}: {
  book: IdeaBookListItem;
  index: number;
}) {
          ...
          <CardContent className="p-5">
            <div className="flex justify-between items-start">
              ...
              <Button
                variant="ghost"
                size="icon"
                className="text-zinc-400 hover:text-zinc-900 -mr-2 -mt-2"
              >
  ...
  return (
    <div className="flex flex-col items-center justify-center py-20 text-center border-2 border-dashed border-zinc-200 rounded-2xl bg-white/50">
      ...
      <p className="text-zinc-500 max-w-sm mb-8">
        Start collecting inspiration for your dream home. Save photos, products,
        and styles you love.
      </p>
      <Button
        onClick={onCreate}
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
      {[1, 2, 3].map((i) => (
        <div
          key={i}
          className="h-80 bg-white rounded-2xl border border-zinc-200 p-4 space-y-4"
        >
