...
function HeroSection() {
  ...
  return (
    <section ref={ref} className="relative h-[90vh] flex items-center justify-center overflow-hidden bg-zinc-900">
      ...
      <div className="relative z-10 container mx-auto px-4 text-center max-w-4xl">
        ...
        >
          <Badge variant="outline" className="mb-6 border-white/20 text-emerald-400 px-4 py-1 text-xs uppercase tracking-widest bg-white/5 backdrop-blur-sm">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Button size="lg" className="h-14 px-8 text-lg bg-emerald-600 hover:bg-emerald-700 text-white rounded-full shadow-lg shadow-emerald-900/20 w-full sm:w-auto" asChild>
              <Link href={ROUTES.joinAsPro}>
                Join as a Pro
                <ArrowRight className="ml-2 h-5 w-5" />
              </Link>
            </Button>
            <Button variant="outline" size="lg" className="h-14 px-8 text-lg border-white/20 text-white hover:bg-white/10 hover:text-white rounded-full bg-transparent w-full sm:w-auto" asChild>
    ...
    <div className="border-b border-zinc-100 bg-white py-12">
      <div className="container mx-auto px-4 text-center">
        ...
        <div className="flex flex-wrap justify-center gap-12 md:gap-20 opacity-60 grayscale transition-all duration-500 hover:grayscale-0 hover:opacity-100">
          ...
          {['NCA', 'AAK', 'IQSK', 'EBK'].map((logo) => (
            <div key={logo} className="flex items-center gap-2 text-xl font-bold text-zinc-800">
  ...
  const features = [
    {
      ...
      description: "We filter out the window shoppers. Get connected with homeowners who have approved budgets and land ready for development."
    },
    {
      icon: ShieldCheck,
    ...
    },
    {
      ...
      description: "Send quotes, manage project milestones, and receive payments directly through our secure platform."
    }
  ];
      ...
      <div className="container mx-auto px-4 max-w-6xl">
        <div className="text-center mb-16 max-w-2xl mx-auto">
          ...
          <p className="text-zinc-500 text-lg">
            The construction industry in Kenya is fragmented. We bring the pieces together to help your business scale efficiently.
          </p>
        </div>
      ...
      <div className="container mx-auto px-4 max-w-7xl">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-16 mb-24">
          ...
          <div className="lg:w-1/2 space-y-6">
            <h3 className="text-3xl font-bold text-zinc-900">Your Digital Command Center</h3>
            <p className="text-lg text-zinc-600 leading-relaxed">
              Managing a construction business is hard. Paper receipts, lost WhatsApp messages, and delayed payments slow you down.
            </p>
            ...
            <Button variant="link" className="text-emerald-600 p-0 h-auto font-semibold text-lg hover:text-emerald-700">
          ...
          <div className="lg:w-1/2">
             <div className="relative rounded-2xl overflow-hidden shadow-2xl aspect-square bg-zinc-100">
                ...
                <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/80 to-transparent p-8">
                   ...
                   <p className="text-white/90 text-sm">Karen Villa Renovation • Budget: KSh 12M</p>
                </div>
             </div>
          </div>
          <div className="lg:w-1/2 space-y-6">
            ...
            <div className="grid grid-cols-2 gap-6 mt-4">
               <div className="p-4 bg-zinc-50 rounded-xl border border-zinc-100">
                  ...
                  <div className="text-sm text-zinc-500">More inquiries for completed profiles</div>
               </div>
               <div className="p-4 bg-zinc-50 rounded-xl border border-zinc-100">
                  <Users className="h-6 w-6 text-emerald-600 mb-2" />
                  <div className="font-bold text-2xl text-zinc-900">24/7</div>
                  <div className="text-sm text-zinc-500">Visibility to clients</div>
               </div>
            </div>
          </div>
        </div>
  ...
  return (
    <section className="py-24 bg-zinc-900 text-white">
      <div className="container mx-auto px-4 max-w-5xl text-center">
        <h2 className="text-3xl font-bold mb-16">Built for Kenyan Professionals</h2>
            ...
            <CardContent className="p-8">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <div className="text-sm text-zinc-400">Lead Architect, Nairobi</div>
                </div>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="p-8">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <div className="text-sm text-zinc-400">Interior Designer, Mombasa</div>
                </div>
              </div>
            </CardContent>
          </Card>
