  ...
  return (
    <div className="flex min-h-screen w-full bg-white">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative bg-zinc-900 items-center justify-center overflow-hidden">
        ...
        <Link href="/professional" className="absolute top-12 left-12 z-20 flex items-center gap-2 group">
           <div className="bg-emerald-600 p-1.5 rounded-lg group-hover:bg-emerald-500 transition-colors">
             <ShieldCheck className="h-5 w-5 text-white" />
           </div>
           <span className="text-xl font-bold tracking-tight text-white">Build<span className="text-emerald-500">Market</span> Pro</span>
        </Link>
           ...
           <div className="mt-12 pt-8 border-t border-zinc-800">
              ...
              <div className="flex items-center gap-3 mt-4">
                ...
                <div>
                  ...
                  <p className="text-[10px] text-zinc-500 uppercase tracking-wider">Lead Structural Engineer, Nairobi</p>
                </div>
              </div>
           </div>
        </div>
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-4 sm:p-8 bg-zinc-50 lg:bg-white">
        <div className="w-full max-w-[440px] space-y-8">
           ...
           <div className="lg:hidden text-center mb-8">
              ...
              <h2 className="text-xl font-semibold text-zinc-900">Professional Registration</h2>
           </div>
