      ...
      <div className="flex-1 flex flex-col items-center justify-center p-4 sm:p-8 bg-zinc-50 lg:bg-white">
        <div className="w-full max-w-[440px] space-y-8">
           ...
           <div className="bg-white p-1 rounded-2xl shadow-xl shadow-zinc-200/50 border border-zinc-100">
             <SignIn 
               routing="hash"
               fallbackRedirectUrl={ROUTES.userDashboard}
               ...
               appearance={{
                 ...
                 elements: {
                   ...
                   formButtonPrimary: "bg-zinc-900 hover:bg-zinc-800 text-white shadow-lg rounded-lg h-11 font-semibold transition-all",
                   ...
                   footerActionLink: "text-emerald-600 hover:text-emerald-700 font-medium hover:underline",
                 },
               }}
             />
           </div>
