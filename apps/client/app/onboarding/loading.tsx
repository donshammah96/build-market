  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-background px-4 py-8 md:px-6 md:py-10">
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute -top-32 -right-32 h-128 w-lg rounded-full bg-onboarding-glow/30 blur-3xl" />
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-6xl flex-col gap-8">
        {/* Breadcrumb skeleton */}
        <div className="flex flex-col gap-4 rounded-[14px] border border-onboarding-primary/25 bg-onboarding-surface/70 px-4 py-4 shadow-[0_24px_55px_-35px_rgba(13,20,32,0.95)] backdrop-blur-md sm:flex-row sm:items-center sm:justify-between md:px-5">
        ...
        <div className="flex flex-col items-center">
          ...
          <Skeleton className="h-5 w-64 sm:w-lg" />
        </div>

        {/* Card skeleton */}
        <div className="mx-auto w-full max-w-2xl">
          <div className="space-y-6 rounded-[18px] border border-onboarding-primary/30 bg-onboarding-surface/80 p-4 shadow-[0_24px_55px_-35px_rgba(13,20,32,0.95)] backdrop-blur-xl sm:p-6 md:p-8">
