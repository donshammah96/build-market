  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-background px-4 py-8 md:px-6 md:py-10">
      ...
      <div className="relative z-10 mx-auto flex min-h-[70vh] w-full max-w-md items-center justify-center">
        <div className="w-full space-y-6 rounded-[18px] border border-[var(--color-onboarding-primary)]/30 bg-[var(--color-onboarding-surface)]/85 p-6 text-center shadow-[0_24px_55px_-35px_rgba(13,20,32,0.95)] backdrop-blur-xl sm:p-8">
          <div className="flex justify-center">
            <div className="rounded-full bg-[var(--color-error)]/10 p-4">
              <AlertCircle className="h-12 w-12 text-[var(--color-error)]" />
            </div>
          </div>
          <h1 className="text-2xl font-semibold text-[var(--color-onboarding-ink)]">
            Something went wrong
          </h1>
          <p className="text-[var(--color-onboarding-ink)]/72">
            We couldn&apos;t load the onboarding form. Please try again.
          </p>
          <Button
            onClick={handleRetry}
            className="min-h-11 w-full bg-[var(--color-onboarding-primary)] text-[oklch(0.08_0.016_222)] hover:opacity-90"
          >
            Try again
          </Button>
        </div>
