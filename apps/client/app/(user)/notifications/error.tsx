...
export default function NotificationsError({
  ...
  return (
    <div className="min-h-screen bg-zinc-50/50 flex flex-col">
      <ClientNavbar />
      <main className="flex-1 container mx-auto px-4 md:px-6 py-8 pt-24 max-w-4xl flex flex-col items-center justify-center">
        <div className="flex flex-col items-center justify-center py-20 text-center max-w-md">
          ...
          <p className="text-zinc-500 mb-6">
            We couldn&apos;t load your notifications. This might be a temporary
            connection issue.
          </p>
