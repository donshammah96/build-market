            ...
            <Card className="border-zinc-200 shadow-sm overflow-hidden bg-white">
              ...
              <div className="px-6 pb-6 relative">
                ...
                <div>
                  ...
                  <p className="text-zinc-500 text-sm mt-1">{formData.city}, {formData.county}</p>
                </div>
            ...
            <Card className="border-zinc-200 shadow-sm bg-white">
              <CardHeader className="border-b border-zinc-100 pb-4">
                <div className="flex items-center justify-between">
                  <div>
                    <CardTitle className="text-lg font-bold text-zinc-900">Profile Details</CardTitle>
              ...
              <CardContent className="pt-6 space-y-6">
                ...
                <div className="space-y-4">
                  <h4 className="text-sm font-medium text-zinc-900 flex items-center gap-2">
                    <UserIcon className="h-4 w-4 text-zinc-400" /> Personal Information
                  </h4>
                ...
                <div className="space-y-4">
                  <h4 className="text-sm font-medium text-zinc-900 flex items-center gap-2">
                    <MapPin className="h-4 w-4 text-zinc-400" /> Location & Contact
                  </h4>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-2">
