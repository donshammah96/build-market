    ...
    <div className="flex min-h-screen w-full bg-white">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative bg-zinc-900 items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
           <Image
             src="/hero-homeowner.jpg" // Ensure you have a nice interior shot in public folder
        ...
        <Link href="/" className="absolute top-8 left-8 z-20 text-xl font-bold tracking-tight text-white">
        ...
        <div className="relative z-10 px-16 max-w-2xl text-white">
           ...
           <div className="mt-12 space-y-5">
              <FeatureItem icon={Search} text="Find Verified Pros & Fundis" />
              <FeatureItem icon={BookOpen} text="Save Ideas to Your Ideabook" />
              <FeatureItem icon={ShieldCheck} text="Get Project Guidance & Support" />
           </div>
        </div>
      </div>
        ...
        <div className="w-full max-w-[440px] space-y-8">
           ...
           <div className="lg:hidden text-center mb-8">
              <Link href="/" className="inline-flex items-center gap-2 mb-6">
                 <span className="text-2xl font-bold text-zinc-900">Build<span className="text-emerald-600">Market</span></span>
              </Link>
             ...
             <SignUp 
               ...
               appearance={{
                 ...
                 elements: {
                   ...
                   socialButtonsBlockButton: "bg-white hover:bg-zinc-50 border border-zinc-200 text-zinc-600 font-medium rounded-lg h-11 transition-colors",
                   socialButtonsBlockButtonText: "font-medium",
                   dividerLine: "bg-zinc-100",
                   dividerText: "text-zinc-400 bg-white px-3 text-xs uppercase tracking-widest font-medium",
                   formButtonPrimary: "bg-emerald-600 hover:bg-emerald-700 text-white shadow-lg shadow-emerald-900/10 rounded-lg h-11 font-semibold transition-all hover:shadow-emerald-900/20",
                   formFieldLabel: "text-zinc-700 font-medium text-sm mb-1.5",
                   formFieldInput: "h-11 border-zinc-200 focus:border-emerald-500 focus:ring-emerald-500/20 rounded-lg bg-zinc-50/50 transition-all",
                   footerActionLink: "text-emerald-600 hover:text-emerald-700 font-medium hover:underline decoration-2 underline-offset-4",
           ...
           <div className="text-center space-y-4">
              <p className="text-sm text-zinc-500">
                Are you a Pro? <Link href={ROUTES.joinAsPro} className="text-emerald-600 font-semibold hover:underline">Join here</Link>
              </p>
              <Link 
                href="/" 
