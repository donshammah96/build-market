...
export declare class MetricsCollector {
     ...
     */
    recordDuration<T>(operation: () => Promise<T>, name: string, tags?: Record<string, string>): Promise<T>;
    /**
...
export declare function setGlobalMetricsCollector(collector: MetricsCollector): void;
