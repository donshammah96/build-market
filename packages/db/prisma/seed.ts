...
const getProfessionalLeadUrl = (id: string) => `${ROUTES.professionalLeads}/${id}`;
const getProfessionalProjectUrl = (id: string) => `${ROUTES.professionalProjects}/${id}`;
const getProjectUrl = (id: string) => `${ROUTES.userProjects}/${id}`;
const getPropertyUrl = (id: string) => `${ROUTES.professionalProperties}/${id}`;
const getNotificationUrl = (id: string) => `${ROUTES.professionalNotifications}/${id}`;
const getTransactionUrl = (id: string) => `${ROUTES.professionalTransactions}/${id}`;
  ...
  await prisma.$transaction(async (tx) => {
    ...
    const engineeringCategory = await tx.serviceCategory.upsert({
      ...
      create: {
        ...
        description: 'Professional engineering services including structural, civil, mechanical, and electrical engineering for construction projects.',
        icon: 'engineering',
        ...
        metaDescription: 'Find verified structural, civil, and building engineers in Kenya for your construction projects.',
        keywords: ['structural engineering', 'civil engineering', 'building design', 'Kenya engineers'],
      },
    });
    ...
    const architectureCategory = await tx.serviceCategory.upsert({
      ...
      create: {
        ...
        description: 'Architectural design, interior design, and landscape architecture services.',
        icon: 'architecture',
        ...
        metaDescription: 'Connect with top architects and designers in Kenya for residential and commercial projects.',
        keywords: ['architect', 'interior design', 'landscape design', 'building design'],
      },
    });
    ...
    const structuralEngService = await tx.service.upsert({
      ...
      create: {
        ...
        description: 'Structural analysis, design, and supervision for buildings and infrastructure.',
        icon: 'building',
        defaultUnit: 'project',
        avgPriceMin: 50000,
        avgPriceMax: 500000,
        searchKeywords: ['structural engineer', 'building structure', 'foundation design', 'beam design'],
        popularityScore: 95,
      },
    });
    ...
    const civilEngService = await tx.service.upsert({
      ...
      create: {
        ...
        categoryId: engineeringCategory.id,
        description: 'Civil engineering services for roads, drainage, water systems, and site development.',
        icon: 'road',
        defaultUnit: 'project',
        avgPriceMin: 100000,
        avgPriceMax: 2000000,
        searchKeywords: ['civil engineer', 'roads', 'drainage', 'site development'],
        popularityScore: 90,
      },
    });
    ...
    const buildingDesignService = await tx.service.upsert({
      ...
      create: {
        ...
        categoryId: engineeringCategory.id,
        description: 'Complete building design from concept to construction drawings.',
        icon: 'blueprint',
        defaultUnit: 'sqm',
        avgPriceMin: 500,
        avgPriceMax: 2500,
        searchKeywords: ['building design', 'construction drawings', 'architectural plans'],
        popularityScore: 88,
      },
    });
    ...
    const architecturalDesignService = await tx.service.upsert({
      ...
      create: {
        ...
        description: 'Full architectural services from concept design to project completion.',
        icon: 'architecture',
        defaultUnit: 'sqm',
        avgPriceMin: 800,
        avgPriceMax: 3000,
        searchKeywords: ['architect', 'house design', 'commercial architecture'],
        popularityScore: 92,
      },
    });
    ...
    const adminUser = await tx.user.upsert({
      where: { email: 'donshammah1@gmail.com' },
      update: {},
      create: {
    ...
    const idealClient = await tx.user.upsert({
      where: { email: 'sohocarti@gmail.com' },
      update: {},
      create: {
        ...
        clientProfile: {
          create: {
            ...
            latitude: -1.2697,
            longitude: 36.8086,
            interests: ['residential construction', 'interior design', 'landscaping', 'smart home'],
    ...
    const idealProfessional = await tx.user.upsert({
      ...
      create: {
        ...
        email: 'buildmarkettest5@gmail.com',
        firstName: 'Evans',
        lastName: 'Ndegwa',
        phone: '+254791938881',
        ...
        professionalProfile: {
          create: {
            ...
            verificationNotes: 'All documents verified. EBK license confirmed valid.',
              ...
              create: [
                {
                  ...
                  fileUrl: 'https://storage.buildmarket.co.ke/licenses/ebk-evans-ndegwa.pdf',
                ...
                },
                {
                  ...
                  validUntil: nextYear,
                  fileUrl: 'https://storage.buildmarket.co.ke/licenses/nca-evans-ndegwa.pdf',
              ...
              create: [
                {
                  ...
                  fileUrl: 'https://storage.buildmarket.co.ke/docs/evans-bsc-civil-eng.pdf',
                ...
                },
                {
                  ...
                  fileUrl: 'https://storage.buildmarket.co.ke/docs/evans-msc-structural-eng.pdf',
                  mimeType: 'application/pdf',
                  size: 312000,
                  status: 'VERIFIED',
                  verifiedAt: lastYear,
                ...
                },
                {
                  ...
                  fileUrl: 'https://storage.buildmarket.co.ke/docs/evans-insurance-policy.pdf',
                  mimeType: 'application/pdf',
                  size: 189000,
                  status: 'VERIFIED',
                  verifiedAt: lastYear,
                ...
                },
                {
                  ...
                  fileUrl: 'https://storage.buildmarket.co.ke/docs/evans-tcc-2024.pdf',
                  mimeType: 'application/pdf',
                  size: 98000,
                  status: 'VERIFIED',
                ...
                },
                {
                  ...
                  fileUrl: 'https://storage.buildmarket.co.ke/docs/evans-cv-2024.pdf',
                  mimeType: 'application/pdf',
                  size: 156000,
                  status: 'VERIFIED',
                  verifiedAt: lastYear,
    ...
    await tx.portfolio.upsert({
      ...
      create: {
        ...
        description: 'A 12-story Class A office complex featuring an innovative structural system with post-tensioned concrete floors and a sustainable facade design. The project achieved EDGE certification for green building standards.',
        projectType: 'COMMERCIAL',
        tags: ['office building', 'high-rise', 'sustainable', 'EDGE certified', 'commercial'],
        ...
        isVerified: true,
        clientTestimonial: 'Evans and his team delivered exceptional structural engineering services. The innovative design saved us 15% on construction costs while maintaining the highest safety standards.',
    ...
    await tx.portfolio.upsert({
      ...
      create: {
        ...
        description: 'A stunning 6-bedroom luxury home featuring cantilevered structures, floor-to-ceiling glass walls, and an infinity pool overlooking the Ngong Hills. The structural design maximizes open spaces while ensuring seismic safety.',
        projectType: 'RESIDENTIAL',
        tags: ['luxury home', 'residential', 'karen', 'modern architecture', 'infinity pool'],
        ...
        isVerified: true,
        clientTestimonial: 'The attention to detail in the structural design allowed for the ambitious architectural vision to become reality. Truly world-class engineering.',
        clientName: 'Private Client',
        images: {
          create: [
            {
              fileKey: 'portfolio/karen-residence-exterior.jpg',
              fileUrl: 'https://images.unsplash.com/photo-1564013799919-ab600027ffc6',
              mimeType: 'image/jpeg',
              size: 560000,
              width: 1920,
              height: 1280,
            ...
            },
            {
              ...
              fileUrl: 'https://images.unsplash.com/photo-1600596542815-ffad4c1539a9',
              mimeType: 'image/jpeg',
              size: 520000,
              width: 1920,
              height: 1280,
    ...
    const activeProject = await tx.project.create({
      data: {
        ...
        description: 'A 6-story residential apartment complex with 48 units, featuring modern amenities including rooftop gardens, gymnasium, and underground parking.',
        type: 'RESIDENTIAL',
        ...
        milestones: {
          create: [
            ...
            },
            {
              ...
              description: 'Concrete columns, beams, and slabs for lower floors',
              amount: 90000000,
              isPaid: true,
              status: 'COMPLETED',
              approvalStatus: 'APPROVED',
            ...
            },
            {
              ...
              description: 'Concrete columns, beams, and slabs for upper floors',
              amount: 90000000,
              isPaid: false,
              status: 'IN_PROGRESS',
    ...
    const professionalStore = await tx.store.create({
      data: {
        id: 'store-001',
        professionalId: idealProfessional.id,
        name: 'Ndegwa Engineering Supplies',
        slug: 'ndegwa-engineering-supplies',
        description: 'Premium construction materials and engineering supplies. Authorized distributor of major brands including Bamburi Cement, ARM Steel, and Davis & Shirtliff pumps.',
        logoUrl: 'https://storage.buildmarket.co.ke/stores/ndegwa-logo.png',
        bannerUrl: 'https://images.unsplash.com/photo-1504307651254-35680f356dfd',
        ...
        categories: ['BUILDING_MATERIALS', 'STEEL_AND_METALS', 'SAFETY_AND_TOOLS'],
        ...
        verified: true,
        verificationStatus: 'VERIFIED',
        verificationNotes: 'All business permits and distributor licenses verified.',
        verifiedAt: lastYear,
        featured: true,
        rating: 4.6,
        reviewCount: 89,
        products: {
          create: [
            ...
            },
            {
              ...
              description: 'High-tensile deformed steel reinforcement bar, 16mm diameter',
              price: 1200,
        ...
        images: {
          create: [
            ...
            },
            {
              ...
              fileUrl: 'https://images.unsplash.com/photo-1565617587748-84d5e4a9e0a0',
              mimeType: 'image/jpeg',
              size: 380000,
              width: 1920,
              height: 1080,
          ...
          create: [
            {
              ...
              fileUrl: 'https://storage.buildmarket.co.ke/stores/docs/ndegwa-business-permit.pdf',
              mimeType: 'application/pdf',
              size: 125000,
              status: 'APPROVED',
              verified: true,
            ...
            },
            {
              ...
              fileUrl: 'https://storage.buildmarket.co.ke/stores/docs/ndegwa-tcc.pdf',
              mimeType: 'application/pdf',
              size: 98000,
              status: 'APPROVED',
              verified: true,
    ...
    await tx.review.create({
      data: {
        ...
        comment: 'We have been sourcing materials from Ndegwa Engineering Supplies for our Kilimani project. Excellent quality products, competitive pricing, and reliable delivery. The team is knowledgeable and always ready to assist.',
        status: 'PUBLISHED',
        helpfulCount: 12,
      },
    });
    ...
    await tx.lead.create({
      data: {
        ...
        description: 'Looking for structural engineering services for a new 8-story commercial development along Mombasa Road. Need preliminary design consultation and cost estimates.',
        projectType: 'COMMERCIAL',
        ...
        notes: 'Client is ready to proceed once proposal is approved. Fast-track timeline expected.',
        lastContactedAt: new Date(now.getFullYear(), now.getMonth(), now.getDate() - 2),
        followUpDate: new Date(now.getFullYear(), now.getMonth(), now.getDate() + 3),
        reminderSent: false,
      },
    });
    ...
    await tx.lead.create({
      data: {
        ...
        description: 'Seeking structural engineering consultancy for hospital wing expansion. Project includes new ICU block and emergency department.',
        projectType: 'COMMERCIAL',
        ...
        followUpDate: new Date(now.getFullYear(), now.getMonth(), now.getDate() + 1),
      },
    });
    ...
    await tx.calendarEvent.create({
      data: {
        ...
        clientId: idealClient.id,
        projectId: activeProject.id,
        guestEmails: ['contractor@buildmarket.com', 'architect@buildmarket.com'],
        title: 'Kilimani Project - Site Inspection',
        description: 'Monthly site inspection to review progress on floors 4-6 structural works. Will assess concrete curing, rebar installation, and MEP coordination.',
        type: 'SITE_VISIT',
        status: 'SCHEDULED',
        startDate: new Date(now.getFullYear(), now.getMonth(), now.getDate() + 7, 10, 0),
        endDate: new Date(now.getFullYear(), now.getMonth(), now.getDate() + 7, 13, 0),
        isAllDay: false,
    ...
    await tx.calendarEvent.create({
      data: {
        ...
        description: 'Deadline to submit EBK license renewal application and documentation.',
        type: 'DEADLINE',
        status: 'SCHEDULED',
    ...
    await tx.notification.create({
      data: {
        ...
        message: 'You have received a new lead from ABC Developers Ltd for a hospital expansion project. Priority: Urgent.',
        type: 'LEAD',
        priority: 'HIGH',
    ...
    await tx.notification.create({
      data: {
        ...
        message: 'Milestone "Structural Framework - Floors 4-6" is now 75% complete for your Kilimani Apartment Complex project.',
        type: 'PROJECT',
        priority: 'MEDIUM',
    ...
    await tx.systemSettings.upsert({
      ...
      create: {
        ...
        enableAutoVerifyERC: false, // Manual ERC verification
        ...
        verificationRules: {
          requiredDocuments: {
            STRUCTURAL_ENGINEER: ['EBK_LICENSE', 'EDUCATION_CERT'],
            ARCHITECT: ['BORAQS_LICENSE', 'EDUCATION_CERT'],
            ELECTRICIAN: ['ERC_LICENSE'],
            GENERAL_CONTRACTOR: ['NCA_LICENSE'],
          },
          maxUploadAttempts: 3,
    ...
    const luxuryProperty = await tx.property.create({
      data: {
        id: 'property-001',
...
Perfect for executives and families seeking luxury living in a serene environment. Minutes from Karen Country Club, shopping centers, and international schools.`,
        ...
        paymentTerms: 'Flexible payment plans available. Bank financing accepted.',
        ...
        // Media
        floorPlanUrl: 'https://storage.buildmarket.co.ke/properties/karen-villa-floorplan.pdf',
          ...
          create: [
            {
              ...
              fileUrl: 'https://storage.buildmarket.co.ke/properties/attachments/karen-villa-floorplan.pdf',
              mimeType: 'application/pdf',
              size: 1250000,
              downloadCount: 89,
              uploadedById: idealProfessional.id,
            },
            {
              ...
              fileUrl: 'https://storage.buildmarket.co.ke/properties/attachments/karen-villa-brochure.pdf',
              mimeType: 'application/pdf',
              size: 3500000,
              downloadCount: 156,
              uploadedById: idealProfessional.id,
          ...
          create: [
            {
              ...
              email: 'sohocarti@gmail.com',
              phone: '+254798798770',
              message: 'I am interested in scheduling a viewing for this property. Is it available this weekend?',
              status: 'PENDING',
            },
          ],
        },
